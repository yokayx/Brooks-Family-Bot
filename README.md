...
Заявки в семью: меню со списком в канале `1453123004308390116` (Main — «Заявка на Young», VZP — «Заявка на Test»), тикеты в категориях открытых/закрытых. Логика: [`docs/applications.md`](docs/applications.md).
