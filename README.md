...
Заявки в семью: меню со списком в канале `1453123004308390116` (Main — «Заявка на Young», VZP — «Заявка на Test») и панель управления в `1553239900176908289` публикуются сами при старте; после выбора состава сразу открывается тикет. Логика: [`docs/applications.md`](docs/applications.md).
